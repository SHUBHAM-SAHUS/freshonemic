    ...
    return (
        ...
        <div className="media-body">
            <div className="article-title">
                <h5>Why Colleges now imposing uniforms? <a href ="/" className="btn btn_outline_follow btn-round prm-btn font-12 mr-2">Follow</a> </h5>
            </div>
            <div className="article-body">
                <h5>I Totally agree <a className="btn btn_home_create btn-round font-12 create-post"><img className="dropdowncross" src={dropdowncross} alt="add"/> &nbsp; Create Post</a> </h5>
                ...
                {/**/}
                <div className="tags mb-4"> <a href ="/" className="btn btn-tags selected mr-1"> #COLLEGE </a> <a href ="/" className="btn btn-tags mr-1"> #EDUCATION </a> <a href ="/" className="btn btn-tags mr-1"> #SCHOOL </a> <a href ="/" className="btn btn-language"> English </a> </div>
                {/*//*/}
