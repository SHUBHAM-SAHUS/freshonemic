        ...
        <div className="media p-3"> <img src={authorOne} alt="John Doe" className="mr-3 rounded-circle" style={{ width: 86 }} />
            <div className="media-body">
                <div className="article-title">
                    <h5>Why Colleges now imposing uniforms? <a href ="/" className="btn btn-round btn_outline_follow font-12 mr-2">Follow</a> </h5>
                </div>
                <div className="article-body">
                    <h5>I Totally agree <a className="btn btn_outline_create btn-round font-12 create-post"><img className="dropdowncross" src={dropdowncross} alt="add" /> &nbsp; Create Post</a> </h5>
