    ...
    return (
        <>
            <div className="card mb-3 border-0 p-3 comments-list-card">
                <div className="media"> <img src="images/author2.jpg" alt="John Doe" className="mr-3 rounded-circle" style={{ width: 50 }} />
                    <div className="media-body">
                        <div className={`${one.article_title} mb-3`}>
                            Commented on <span className="comment">Why Colleges now imposing uniforms?</span> <span className="text-primary">with</span> <span className="commentagree">I totally agree</span>
                        </div>
