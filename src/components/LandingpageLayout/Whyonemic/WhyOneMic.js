            ...
            <div className="row ">
              <div className="col-md-3 col-md-mt-1">
                <div className="widget text-center">
                  ...
                  <h4 className="widget-heading whyonemic_h4">Play your favorites</h4>
                  <p className="widget-body whyonemic_p">Lorem ipsum dolor sit amet, consectetur adipiscing elit, incididunt ut labore et dolore magna aliqua. </p>
                  <a className="whyonemic_a" href="#">more...</a>
                </div>
              </div>
